	...
	<div class="card">
		<div class="card-body">
			<div class="ionvoiceHeader ">
				<h4>invoice Data</h4>
				<a href="{{ route("admin.salesPage") }}" class="btn create">Create Sales</a>
			</div>	
			<hr>	
...
<script type="text/javascript">
	...
	function invoiceAllData(){
		...
		var url = "{{ route('admin.InvoiceAll') }}";
		axios.get(url)
	...
	function invoiceViewShow(viewId){
		...
		var url = "{{ route('admin.InvoiceViewShow') }}";
	...
	function InvSalsDelete(InvDelId){
		Swal.fire({
		  ...
		  if (result.isConfirmed) {
		   var url = "{{ route('admin.invoiceDelete') }}";
